...
class Product extends Model
{
    ...
    {
        return $this->belongsTo(Category::class, 'KODE_KATEGORI', 'KODE');
    }

    public function formula()
    {
        return $this->belongsTo(Formula::class, 'KODE_RUMUS', 'KODE');
    }

    public function special_prices()
    {
        return $this->hasMany(SpecialPrice::class, 'KODE_PRODUK', 'KODE');
    }
